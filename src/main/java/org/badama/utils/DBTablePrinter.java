...
public class DBTablePrinter {
    ...
    public static void printTable(Connection conn, String tableName, int maxRows, int maxStringColWidth) {
        ...
        try {
            ...
            ResultSetExtended rse = new ResultSetExtended();
            rse.setResultSet(rs);

            printResultSet(rse, maxStringColWidth);
     ...
     *
     * @param rse The <code>ResultSet</code> to print
     */
    public static void printResultSet(ResultSetExtended rse) {
        printResultSet(rse, DEFAULT_MAX_TEXT_COL_WIDTH);
    }
     ...
     * @param maxStringColWidth Max. width of text columns
     */
    public static void printResultSet(ResultSetExtended rse, int maxStringColWidth) {
        ...
        try {
            ...
            if (rowCount == 0) {
                info = "No rows returned by query.";
                System.out.println(info);
            } else {
                info = rowCount + " row(s) returned by query on " + sj.toString();
                System.out.println(info);
